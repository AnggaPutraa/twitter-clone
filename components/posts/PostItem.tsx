...
const PostItem = ({ userId, data }: PostItemProps) => {
    ...
    const handleNavigateToProfile = useCallback((event: any) => {
                ...
                <div>
                    <div className="flex flex-row items-center gap-2">
                        <p
                            ...
                            className="text-white font-semibold cursor-pointer hover:underline">{data.user.name}
                        </p>
                        <span
                            onClick={handleNavigateToProfile}
                            className="text-neutral-500 cursor-pointer hidden md:block">@{data.user.username}
                        </span>
